...
class AdsImageServiceImplTest {
    ...
    void createAdsImage() throws IOException, URISyntaxException {
        ...
        AdsImage image = createImage(multipartFile, adsEntity);
        ...
        AdsImage expected = createImage(multipartFile, adsEntity);
    ...
    void updateAdsImage() throws URISyntaxException, IOException {
        ...
        when(adsImageRepository.findAdsImageByAdsEntity_Id(any())).thenReturn(Optional.of(image));
    ...
    private AdsImage createImage(MultipartFile image, AdsEntity adsEntity) {
